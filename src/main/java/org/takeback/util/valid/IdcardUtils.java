...
public class IdcardUtils
{
  ...
  private static Pattern pPassport = Pattern.compile("^(P\\d{7}|G\\d{8}|S\\d{7,8}|D\\d+|1[4,5]\\d{7})$");
...
/* Location:              E:\apache-tomcat-8\apache-tomcat-8\webapps\ROOT\WEB-INF\classes\!\org\takeback\util\valid\IdcardUtils.class
