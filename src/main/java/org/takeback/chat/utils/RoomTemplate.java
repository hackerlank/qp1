...
public class RoomTemplate
{
  ...
  public static void G022() {
    ...
    GcRoomProperty p1 = new GcRoomProperty("conf_money", "单倍金额", "5", "单倍输赢金额");
    GcRoomProperty p2 = new GcRoomProperty("conf_expired", "过期时间", "60", "游戏包失效时间，单位秒");
    GcRoomProperty p3 = new GcRoomProperty("conf_size", "初始红包个数", "5", "红包个数");
    GcRoomProperty p4 = new GcRoomProperty("conf_lose", "N点以下闲输", "2", "这个点数以下算闲家输");
    GcRoomProperty p5 = new GcRoomProperty("conf_max_size", "最大红包个数", "20", "最大红包个数");
    GcRoomProperty p6 = new GcRoomProperty("conf_n1", "牛1倍数", "1", "牛1倍数");
    GcRoomProperty p7 = new GcRoomProperty("conf_n2", "牛2倍数", "2", "牛2倍数");
    GcRoomProperty p8 = new GcRoomProperty("conf_n3", "牛3倍数", "3", "牛3倍数");
    GcRoomProperty p9 = new GcRoomProperty("conf_n4", "牛4倍数", "4", "牛4倍数");
    GcRoomProperty p10 = new GcRoomProperty("conf_n5", "牛5倍数", "5", "牛5倍数");
    GcRoomProperty p11 = new GcRoomProperty("conf_n6", "牛6倍数", "6", "牛6倍数");
    GcRoomProperty p12 = new GcRoomProperty("conf_n7", "牛7倍数", "7", "牛7倍数");
    GcRoomProperty p13 = new GcRoomProperty("conf_n8", "牛8倍数", "8", "牛8倍数");
    GcRoomProperty p14 = new GcRoomProperty("conf_n9", "牛9倍数", "9", "牛9倍数");
    GcRoomProperty p15 = new GcRoomProperty("conf_n10", "牛牛倍数", "10", "牛牛倍数");
    GcRoomProperty p16 = new GcRoomProperty("conf_n11", "金牛部署", "11", "金牛倍数");
    GcRoomProperty p17 = new GcRoomProperty("conf_n12", "对子倍数", "12", "对子倍数");
    GcRoomProperty p18 = new GcRoomProperty("conf_n13", "顺子倍数", "13", "顺子倍数");
    GcRoomProperty p19 = new GcRoomProperty("conf_n14", "满牛倍数", "14", "0对倍数");
    GcRoomProperty p20 = new GcRoomProperty("conf_n15", "豹子倍数", "15", "豹子倍数");
    g02Prop.add(p1);
    g02Prop.add(p2);
    g02Prop.add(p3);
    g02Prop.add(p4);
  ...
  public static void G05()
  {
    List<GcRoomProperty> g02Prop = new ArrayList();
    templates.put("G05", g02Prop);
    GcRoomProperty p1 = new GcRoomProperty("conf_min_master", "最低竞标金额", "5000", "最低竞标金额");
    GcRoomProperty p8 = new GcRoomProperty("conf_expired", "过期时间", "60", "游戏包失效时间，单位秒");
    ...
    GcRoomProperty p21 = new GcRoomProperty("conf_n12", "对子倍数", "11", "对子倍数");
    GcRoomProperty p22 = new GcRoomProperty("conf_n14", "满牛倍数", "14", "0对倍数");
    GcRoomProperty p23 = new GcRoomProperty("conf_n15", "豹子倍数", "15", "豹子倍数");
    g02Prop.add(p21);
    g02Prop.add(p22);
    g02Prop.add(p23);
    
    GcRoomProperty p24 = new GcRoomProperty("conf_n13", "顺子倍数", "13", "顺子倍数");
    GcRoomProperty p25 = new GcRoomProperty("conf_n11", "金牛部署", "11", "金牛倍数");
  ...
  public static void G04()
  {
    ...
    GcRoomProperty b1 = new GcRoomProperty("p_5", "5包赔付倍数", "2", "中雷者赔付的倍数");
    g01Prop.add(b1);
    GcRoomProperty b2 = new GcRoomProperty("p_6", "6包赔付倍数", "1.8", "中雷者赔付的倍数");
    g01Prop.add(b2);
    GcRoomProperty b3 = new GcRoomProperty("p_7", "7包赔付倍数", "1.6", "中雷者赔付的倍数");
    g01Prop.add(b3);
    GcRoomProperty b4 = new GcRoomProperty("p_8", "8包赔付倍数", "1.4", "中雷者赔付的倍数");
    g01Prop.add(b4);
    GcRoomProperty b5 = new GcRoomProperty("p_9", "9包赔付倍数", "1.2", "中雷者赔付的倍数");
    g01Prop.add(b5);
    GcRoomProperty b6 = new GcRoomProperty("p_10", "10包赔付倍数", "1.1", "中雷者赔付的倍数");
    g01Prop.add(b6);
  }
}


/* Location:              E:\apache-tomcat-8\apache-tomcat-8\webapps\ROOT\WEB-INF\classes\!\org\takeback\chat\utils\RoomTemplate.class
