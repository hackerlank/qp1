...
define('DB_PWD', 'nuttertoolstf..@@#');//数据库密码
define('DB_NAME', 'gamechat');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'pub_user');  //充值用户所在数据库表名
